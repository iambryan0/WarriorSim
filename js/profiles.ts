...
SIM.PROFILES = {
    ...
    getItem(id) {
        for (let type in gear) for (let item of gear[type]) if (item.id == id) return item;
    },
    ...
    exportProfile: function (profile) {
        ...
        minified.gear = {};
        for (let type in storage.gear) {
            for (let item of storage.gear[type]) if (item.selected) minified.gear[type] = item.id;
        }
        minified.rotation = [];
        ...
        for (let type in storage.runes) {
            for (let item of storage.runes[type]) if (item.selected) minified.runes[type] = item.id;
        }
        minified.enchant = {};
        ...
        try {
            ...
            for (let spell of storage.rotation) {
                ...
                if (newspell) {
                    ...
                    if (typeof newspell.timetoendactive !== 'undefined')
                        spell.timetoendactive = newspell.timetoendactive;
                    if (typeof newspell.timetostart !== 'undefined') spell.timetostart = newspell.timetostart;
                    if (typeof newspell.timetostartactive !== 'undefined')
                        spell.timetostartactive = newspell.timetostartactive;
                    ...
                    if (typeof newspell.rageblockactive !== 'undefined')
                        spell.rageblockactive = newspell.rageblockactive;
                    ...
                    if (typeof newspell.priorityapactive !== 'undefined')
                        spell.priorityapactive = newspell.priorityapactive;
                    ...
                    if (typeof newspell.switchtimeactive !== 'undefined')
                        spell.switchtimeactive = newspell.switchtimeactive;
                    if (typeof newspell.swingtimeractive !== 'undefined')
                        spell.swingtimeractive = newspell.swingtimeractive;
                    ...
                    if (typeof newspell.switchechoesactive !== 'undefined')
                        spell.switchechoesactive = newspell.switchechoesactive;
                    if (typeof newspell.switchechoestime !== 'undefined')
                        spell.switchechoestime = newspell.switchechoestime;
                    if (typeof newspell.switchechoesrage !== 'undefined')
                        spell.switchechoesrage = newspell.switchechoesrage;
                    ...
                    if (typeof newspell.secondarystance !== 'undefined')
                        spell.secondarystance = newspell.secondarystance;
                } else {
                    spell.active = false;
                }
            }
            ...
            for (let type in minified.enchant) {
                ...
                for (let e of minified.enchant[type]) storage.enchant[type].push({ id: e, selected: true });
            }
